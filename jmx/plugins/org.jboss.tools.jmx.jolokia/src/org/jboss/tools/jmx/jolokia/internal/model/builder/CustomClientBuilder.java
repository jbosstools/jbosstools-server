...
public class CustomClientBuilder {
     ...
     */
    public final CustomClientBuilder url(String pUrl) {
        url = pUrl;
        return this;
    }
     ...
     */
    public final CustomClientBuilder user(String pUser) {
        user  = pUser;
        return this;
    }
     ...
     */
    public final CustomClientBuilder password(String pPassword) {
        password  = pPassword;
        return this;
    }
     ...
     */
    public final CustomClientBuilder target(String pUrl) {
        targetUrl = pUrl;
        return this;
    }
     ...
     */
    public final CustomClientBuilder targetUser(String pUser) {
        targetUser = pUser;
        return this;
    }
     ...
     */
    public final CustomClientBuilder targetPassword(String pPassword) {
     ...
     */
    public final CustomClientBuilder singleConnection() {
     ...
     * tuning the pool}
     */
    public final CustomClientBuilder pooledConnections() {
     ...
     */
    public final CustomClientBuilder connectionTimeout(int pTimeOut) {
     ...
     */
    public final CustomClientBuilder socketTimeout(int pTimeOut) {
     ...
     */
    public final CustomClientBuilder maxTotalConnections(int pConnections) {
     ...
     */
    public final CustomClientBuilder maxConnectionPoolTimeout(int pConnectionPoolTimeout) {
     ...
     */
    public final CustomClientBuilder contentCharset(String pContentCharset) {
     ...
     * @param pContentCharset the charset to use
     */
    public final CustomClientBuilder contentCharset(Charset pContentCharset) {
     ...
     */
    public final CustomClientBuilder expectContinue(boolean pUse) {
        expectContinue = pUse;
        return this;
    }
     ...
     */
    public final CustomClientBuilder tcpNoDelay(boolean pUse) {
        tcpNoDelay = pUse;
        return this;
    }
     ...
     */
    public final CustomClientBuilder socketBufferSize(int pSize) {
     ...
     */
    public final CustomClientBuilder cookieStore(CookieStore pCookieStore) {
     ...
     */
    public final CustomClientBuilder authenticator(J4pAuthenticator pAuthenticator) {
     ...
     */
    public final CustomClientBuilder proxy(String pProxy) {
     ...
     */
    public final CustomClientBuilder proxy(String pProxyHost, int pProxyPort) {
     ...
     */
    public final CustomClientBuilder proxy(String pProxyHost, int pProxyPort, String pProxyUser, String pProxyPass) {
     ...
     */
    public final CustomClientBuilder useProxyFromEnvironment(){
     ...
     */
    public final CustomClientBuilder responseExtractor(J4pResponseExtractor pResponseExtractor) {
     ...
     */
    public final CustomClientBuilder sslConnectionSocketFactory(ConnectionSocketFactory pSslConnectionSocketFactory) {
    ...
    public HttpClient createHttpClient() {
        ...
        clientBuilderAdditions(builder);
    ...
    protected void clientBuilderAdditions(HttpClientBuilder builder) {
