	...
	public TabFolderSupport2(final String contributorId, boolean showTitle) {
		super(new ITabbedPropertySheetPageContributor() {
			...
			public String getContributorId() {
				return "org.jboss.tools.jmx.commons.propertyContributor";
			}
		}, showTitle);
		...
		try {
			...
			Activator.getLogger().error("Failed to change the 'registry' field on " + this + ". " + e, e);
		}

		try {
			selectionQueue = (List) Objects.getField(this, "selectionQueue", TabbedPropertySheetPage.class);
		} catch (Exception e) {
			Activator.getLogger().error("Failed to get the 'selectionQueue' field on " + this + ". " + e, e);
		}
	}
