...
public class Constants {
    ...
    /** The logger name. */
    static final String LOGGER_NAME = "org.jboss.tools.jmx.jvmmonitor.agent";
    ...
    static final String CLASS_CPU_PROFILER = "org/jboss/tools/jmx/jvmmonitor/internal/agent/CpuBciProfiler";
