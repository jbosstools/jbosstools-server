...
public class ServerBeanTypeWildfly180Web extends JBossServerType {
	...
	public static class Wildfly180WebServerTypeCondition extends AbstractCondition {
		...
		public String getFullVersion(File location, File systemFile) {
			...
			if( vers != null && vers.startsWith("18.")) {
				return vers;
			}
			return null;
		}
		...
		public String getServerTypeId(String version) {	
			return IJBossToolingConstants.SERVER_WILDFLY_180;
		}
	}
}
