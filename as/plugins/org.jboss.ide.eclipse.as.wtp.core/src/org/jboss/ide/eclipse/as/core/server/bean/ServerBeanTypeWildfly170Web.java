...
public class ServerBeanTypeWildfly170Web extends JBossServerType {
	...
	public ServerBeanTypeWildfly170Web() {
		super(
				...
				new String[]{"17.0"}, new Wildfly170WebServerTypeCondition());
	}
	...
	public static class Wildfly170WebServerTypeCondition extends AbstractCondition {
		...
		public String getFullVersion(File location, File systemFile) {
			...
			if( vers != null && vers.startsWith("17.")) {
				return vers;
			}
			return null;
		}
		...
		public String getServerTypeId(String version) {	
			return IJBossToolingConstants.SERVER_WILDFLY_170;
		}
	}
}
