...
public class ServerBeanTypeWildfly160Web extends JBossServerType {
	...
	public ServerBeanTypeWildfly160Web() {
		super(
				...
				new String[]{"16.0"}, new Wildfly160WebServerTypeCondition());
	}
	...
	public static class Wildfly160WebServerTypeCondition extends AbstractCondition {
