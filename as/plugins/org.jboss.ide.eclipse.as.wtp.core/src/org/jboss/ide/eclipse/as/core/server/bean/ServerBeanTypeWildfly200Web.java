...
public class ServerBeanTypeWildfly200Web extends JBossServerType {
	...
	public static class Wildfly200WebServerTypeCondition extends AbstractCondition {
		...
		public String getFullVersion(File location, File systemFile) {
			...
			if( vers != null && vers.startsWith("20.")) {
				return vers;
			}
			return null;
		}
		...
		public String getServerTypeId(String version) {	
			return IJBossToolingConstants.SERVER_WILDFLY_200;
		}
	}
}
