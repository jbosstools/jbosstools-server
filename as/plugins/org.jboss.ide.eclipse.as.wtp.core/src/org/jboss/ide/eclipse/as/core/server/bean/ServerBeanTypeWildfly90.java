...
public class ServerBeanTypeWildfly90 extends JBossServerType {
	...
	public static class Wildfly90ServerTypeCondition extends AbstractCondition {
		...
		public String getFullVersion(File location, File systemFile) {
			String vers = ServerBeanType.getManifestPropFromJBossModulesFolder(new File[]{new File(location, "modules")}, 
					"org.jboss.as.product", "wildfly-full/dir/META-INF", WF_90_RELEASE_MANIFEST_KEY);
