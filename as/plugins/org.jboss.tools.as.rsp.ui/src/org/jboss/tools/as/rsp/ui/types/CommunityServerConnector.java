...
/**
 * Provides the id, name, ports, icons, and download information for the latest
 * version of the Community Server Connector.
 */
public class CommunityServerConnector extends AbstractServerConnector {
	public CommunityServerConnector() {
		super("redhat-community-server-connector", "Community Server Connector by Red Hat", 9000, 9500,
				"community-24x24.png",
	...
	protected IRsp createFallbackRsp(IRspCore core) {
		return getType(core).createRsp("0.23.5.Final",
				"https://download.jboss.org/jbosstools/adapters/snapshots/rsp-server-community/distributions/0.23.5.Final/org.jboss.tools.rsp.server.community.distribution-0.23.5.Final.zip");
	};
