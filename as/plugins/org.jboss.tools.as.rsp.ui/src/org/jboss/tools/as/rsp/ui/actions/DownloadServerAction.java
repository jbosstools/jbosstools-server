...
public class DownloadServerAction extends AbstractTreeAction {
    ...
    private void initiateDownloadRuntimeWorkflow(IRsp server, RspClientLauncher client, DownloadRuntimeDescription chosen) {
        ...
        do {
            ...
            Display.getDefault().syncExec(() -> {
            	Map<String, Object> tmp = 
            			WorkflowUiUtility.displayPromptsSeekWorkflowInput(
            					"Downloading " + chosen.getName(),
            					"This is a workflow for downloading the selected runtime",
            					resp2);
            	if( tmp != null ) 
            		toSend.putAll(tmp);
            });
