...
public class Wildfly180ExtendedProperties extends JBossAS710ExtendedProperties {
	public Wildfly180ExtendedProperties(IAdaptable obj) {
		super(obj);
	}
	@Override
	public String getRuntimeTypeVersionString() {
		return "18.0"; //$NON-NLS-1$
	}
	...
	/**
	 * Wildfly 18 appears to work through java 11 to varying degrees
	 */
	@Override
