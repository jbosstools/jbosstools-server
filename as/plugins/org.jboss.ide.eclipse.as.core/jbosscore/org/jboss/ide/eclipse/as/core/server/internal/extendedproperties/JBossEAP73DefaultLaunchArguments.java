...
public class JBossEAP73DefaultLaunchArguments extends JBossEAP70DefaultLaunchArguments {

	public JBossEAP73DefaultLaunchArguments(IServer s) {
		super(s);
	}

	public JBossEAP73DefaultLaunchArguments(IRuntime rt) {
		super(rt);
	}
