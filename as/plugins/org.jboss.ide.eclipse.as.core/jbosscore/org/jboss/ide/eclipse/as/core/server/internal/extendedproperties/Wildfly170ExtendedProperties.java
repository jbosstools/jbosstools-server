...
public class Wildfly170ExtendedProperties extends JBossAS710ExtendedProperties {
	public Wildfly170ExtendedProperties(IAdaptable obj) {
		super(obj);
	}
	@Override
	public String getRuntimeTypeVersionString() {
		return "17.0"; //$NON-NLS-1$
	}
	...
	/**
	 * Wildfly 17 appears to work through java 11 to varying degrees
	 */
	@Override
