...
public class ServerBeanRuntimeMatcherTest extends TestCase {
	...
	public void setUp() {
		...
		expected.put(IJBossToolingConstants.SERVER_EAP_80, new Data(JBossServerType.EAP80, "8.0"));
		expected.put(IJBossToolingConstants.SERVER_WILDFLY_270, new Data(JBossServerType.WILDFLY270, "27.0"));
