...
public class ServerCreationTestUtils extends Assert {
	...
	static {
		...
		asSystemJar.put(IJBossToolingConstants.SERVER_EAP_80, "eap7.3.0.mf.jboss-as-server.jar");
		asSystemJar.put(IJBossToolingConstants.SERVER_WILDFLY_270, "wf21.0.0.mf.jboss-as-server.jar");
		...
		serverRuntimeMap.put(IJBossToolingConstants.SERVER_EAP_80, IJBossToolingConstants.EAP_80);
		serverRuntimeMap.put(IJBossToolingConstants.SERVER_WILDFLY_270, IJBossToolingConstants.WILDFLY_270);
		// AUTOGEN_SERVER_ADAPTER_CHUNK
		// NEW_SERVER_ADAPTER Add the new runtime constant above this line
